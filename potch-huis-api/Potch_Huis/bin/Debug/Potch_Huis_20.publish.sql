...
IF EXISTS (select top 1 1 from [dbo].[Request])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'The following operation was generated from a refactoring log file 09c9fba4-726c-4019-ba7c-69b5fafec294, 6ffe5398-959e-4c4e-b927-df0d4fd073b8, 44fab115-e1cb-404c-a51f-9321b5ec3d98';

PRINT N'Rename [dbo].[Request].[StockNumber] to ItemNumber';


GO
EXECUTE sp_rename @objname = N'[dbo].[Request].[StockNumber]', @newname = N'ItemNumber', @objtype = N'COLUMN';
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Request] ([Id], [Value], [MemberNumber], [Received], [Confirmed])
        SELECT [Id],
               [Value],
               [MemberNumber],
               [Received],
