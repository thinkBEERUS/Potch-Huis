...
GO
PRINT N'Altering Procedure [dbo].[spPassword_Insert]...';


GO
ALTER PROCEDURE [dbo].[spPassword_Insert]
    @Salt varbinary(MAX), 
    @Hash NVARCHAR(MAX), 
...
END
GO
PRINT N'Altering Procedure [dbo].[spPassword_Update]...';


GO
ALTER PROCEDURE [dbo].[spPassword_Update]
    @Salt varbinary(MAX),
    @Hash VARCHAR(MAX),
    @MemberNumber NVARCHAR(50)
AS
