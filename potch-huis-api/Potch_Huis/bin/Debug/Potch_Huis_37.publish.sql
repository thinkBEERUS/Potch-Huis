...
AS
BEGIN
	DELETE FROM dbo.ConfirmedDonations WHERE MemberNumber = @MemberNumber;
END
GO
...
AS
BEGIN
	DELETE FROM dbo.Donation WHERE MemberNumber = @MemberNumber;
END
GO
...
AS
BEGIN
	INSERT INTO dbo.Donation ([Type], Amount, [Description], Purpose, MemberNumber, DonationNumber)
    VALUES (@Type, @Amount, @Description, @Purpose, @MemberNumber, @DonationNumber)
END
GO
...
AS
BEGIN
	INSERT INTO dbo.RequestedItems ([Name], Quantity, [Value], RequestNumber, StockNumber, ItemNumber)
    VALUES (@Name, @Quantity, @Value, @RequestNumber, @StockNumber, @ItemNumber)
END
GO
